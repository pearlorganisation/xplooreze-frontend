...
`;
          window.open(
            `https://wa.me/919945693172?text=${encodeURIComponent(message)}`,
            "_blank",
          );
        }}
      />
      <header className="hero">
        <div className="header-content">
          <div className="hero-content">
            ...
            <p>
              Find your ideal tutor with Xplooreze verified subject experts,
              <br />
              tailored lessons, and flexible learning designed to help you
      ...
      <div className="welcome-content">
        <div className="content-section services">
          ...
          <div className="services-items">
            <div className="service-item">
              ...
              <h1>Home Tutoring</h1>
              <h3>
                Trusted home tutors for personalised one-on-one learning. Boost
                grades and confidence with safe, interactive lessons at your
                doorstep.
              </h3>
              ...
              <button
                onClick={() =>
                  navigate(
                    "/authentication?authType=registration&userRole=student&tutoringMode=Home%20Tutoring",
                  )
                }
            ...
            <div className="service-item">
              ...
              <h3>
                Learn from expert online tutors anywhere in India. Flexible live
                classes for school subjects, test preparation and skill
                development
              </h3>
            ...
            <div className="service-item">
              ...
              <h3>
                Book 1-on-1 calls with experienced professors for complete PhD
                research support from topic selection to thesis completion and
                publication.
              </h3>
              <img src="/content-writing.avif" />
              <button
                onClick={() => navigate("/phd-mentorship")}
                className="welcome-section-button"
              >
                1-on-1 PhD Help →
              </button>
        ...
        <div className="content-section">
          <div className="how-we-work-card">
            <HeaderTitle
              title="How We Work"
              description="Find the perfect tutor for home or online classes in simple 4 steps"
            />
            <div className="how-we-work-steps">
              <div className="how-we-work-step">
                ...
                <p>
                  Select subject, grade, pincode (for home) or "online" (for
                  virtual). Choose your timing.
                </p>
              </div>
              <div className="how-we-work-step">
                ...
                <h1>We Match You</h1>
                <p>
                  Get instant matches with verified tutors in your area or
                  across India online.
                </p>
              </div>
              <div className="how-we-work-step">
                ...
                <p>
                  Check profiles, ratings and fees. Shortlist your favourites.
                </p>
              </div>
              <div className="how-we-work-step">
                ...
                <p>
                  Book a demo or start classes. Pay securely through
                  UPI/Razorpay.
                </p>
              </div>
            </div>
        ...
        <div className="content-section" id="tutor-registration">
          <div className="tutor-card">
            ...
            <div className="tutor-card-content">
              ...
              <p>
                Share your knowledge with learners around the world. Whether
                you're a skilled educator or simply passionate about teaching,
                our platform makes it easy to connect with students and start
                tutoring.
              </p>
              <ul>
        ...
        <div className="content-section testimonials">
          ...
          <div className="testimonials-items">
            <div className="testimonial-item">
              ...
              <p>
                "I struggled to meet deadlines for my dissertation, but
                Xplooreze helped me find credible sources, develop a strong
                research question, and organize my findings. Their communication
                was excellent, and they were always available to answer
            ...
            <div className="testimonial-item">
              ...
              <p>
                "Working with Xplooreze was amazing. They provided in-depth,
                unbiased research support on a complex topic, and their
                expertise helped my proposal get accepted in one go. Truly
            ...
            <div className="testimonial-item">
              ...
              <p>
                "Extremely satisfied with Xplooreze. They helped edit my
                dissertation, analyze data, and improve my writing. Their
                support was thorough, professional, and made the process smooth
                and stress-free."
              </p>
            </div>
            <div className="testimonial-item">
              ...
              <p>
                "Xplooreze provided quality research materials and helped refine
                my methodology and writing style. Their detailed feedback on
                drafts was invaluable. I’m grateful for their guidance and
                support throughout."
              </p>
            </div>
          </div>
        ...
        <div className="content-section meet-the-founder">
          ...
          <img src="/founder.jpg" />
          <p>
            Hi, I’m Dr. Ruchi Jain. After mentoring business students across the
            world and working with top U.S.-based ed-tech platforms for 17
            years, I saw how hard it was for families to find trusted tutors
            nearby.
            <br />
            That’s why I created Xplooreze—to make quality tutoring accessible,
            personal, and safe.
            <br />
            <a href="/about-us">Read the full story →</a>
          </p>
        </div>
