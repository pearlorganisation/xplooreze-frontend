...
export function VerificationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (showAddressProof && !formData.addressProof) {
      setError(
        "Address Proof is required because you selected 'At Tutor Place'.",
      );
      return;
    }
    // --- End Validation ---
    ...
    try {
      ...
      setSuccess(
        "Documents submitted successfully! Your profile will be re-verified.",
      );
      ...
      <>
        ...
        {rejectionReason && (
          <div className="rejection-message">
            <p>
              <strong>Your profile was rejected.</strong>
            </p>
            <p>Reason: {rejectionReason}</p>
            <p>
              Please re-upload the correct documents below. Your previous files
              will be replaced.
            </p>
          </div>
        )}
        ...
        <div className="form-group">
          ...
          />
          <small>
            Upload up to 5 files. Your previous uploads will be replaced.
          </small>
        </div>
        ...
        {showAddressProof && (
          <div className="form-group">
            ...
            />
            <small>
              Required because you offer tutoring "At Tutor Place". Your
              previous upload will be replaced.
            </small>
          </div>
        )}
    ...
    <div className="verification-page">
      ...
      <main className="verification-content">
        ...
        <form className="form-details" onSubmit={handleSubmit}>
          <div className="other-details">{renderFormContent()}</div>
        </form>
