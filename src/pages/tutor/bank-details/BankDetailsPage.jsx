...
export function BankDetailsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.message || "Failed to save details. Please check your inputs.",
      );
    } finally {
      setIsSaving(false);
    }
    ...
    return (
      <>
        ...
        <div className="grid-2">
          ...
          <div className="form-group">
            <label htmlFor="branch" className="required">
              Branch
            </label>
            <input
              type="text"
        ...
        <div className="grid-2">
          <div className="form-group">
            <label htmlFor="bankAccountHolderName" className="required">
              Account Holder Name
            </label>
            <input
              type="text"
