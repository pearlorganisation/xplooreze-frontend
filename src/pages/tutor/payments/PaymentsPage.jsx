      ...
      <main className="payments-main">
        ...
        <div className="balance-card">
          <div className="balance-main">
            <h1 className="balance-value">
              {availableBalance.toLocaleString()} INR
            </h1>
          ...
          <div className="balance-breakdown">
            <div className="breakdown-item">
              ...
              <span className="breakdown-value">
                {insights.totalEarning.toLocaleString()} INR
              </span>
            </div>
            <div className="breakdown-item">
              <span className="breakdown-label">Total withdrawn</span>
              <span className="breakdown-value withdrawn">
                {insights.totalWithdrawals.toLocaleString()} INR
              </span>
            </div>
          </div>
        </div>
        {transactions.length === 0 ? (
          <div className="empty-state">
            ...
            <p>
              Your payment history will appear here once you make withdrawals.
            </p>
          </div>
        ) : (
                ...
                {transactions.map((transaction, index) => (
                  ...
                  >
                    ...
                    <td className="amount-cell">
                      {(transaction.amount || 0).toLocaleString()} INR
                    </td>
